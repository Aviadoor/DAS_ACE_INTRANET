...
@section('page-title', 'Editar Permiso: ' . $permiso->Nombre)
    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            ...
            <textarea class="form-control @error('Descripcion') is-invalid @enderror" 
                    ...
                    name="Descripcion" 
                    rows="3" 
                    style="resize: none;">{{ old('Descripcion', $permiso->Descripcion) }}</textarea>
            @error('Descripcion')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row g-3 mb-4 border rounded p-3 bg-light shadow-sm mx-0">
        <div class="col-12">
            <div class="form-check form-switch fs-5 mb-0">
                <input class="form-check-input" type="checkbox" role="switch" id="Habilitado" name="Habilitado" value="1" {{ old('Habilitado', $permiso->Habilitado) ? 'checked' : '' }}>
